...
return {
	...
	-- Set SHELL env var to the homebrew-installed bash
	...
	-- Configure cursor shape changes
	default_cursor_style = "SteadyBlock", -- Default to block cursor
	cursor_blink_ease_in = "Linear",
	cursor_blink_ease_out = "Linear",
	cursor_blink_rate = 0,
	-- Use the correct fields for cursor configuration
